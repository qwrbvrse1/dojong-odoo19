 ...
 *
 * Registered as: ai_assistant.walkie_channel
 */
...
class DojoWalkieChannel extends Component {
    static template = "ai_assistant.WalkieChannel";
...
registry.category("actions").add("ai_assistant.walkie_channel", DojoWalkieChannel);
