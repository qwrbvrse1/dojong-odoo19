 ...
 *
 * Registered as: dojo_assistant.walkie_elder
 */
...
class DojoWalkieElder extends Component {
    static template = "dojo_assistant.WalkieElder";
...
registry.category("actions").add("dojo_assistant.walkie_elder", DojoWalkieElder);
