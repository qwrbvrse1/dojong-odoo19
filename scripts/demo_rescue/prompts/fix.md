...
2. Update your `docs/rescue/S<N>_PLAN.md` with the corrective step BEFORE editing.
3. Apply the smallest fix. If your previous approach caused this, revert it
   (`git checkout -- <file>` or revert to `main`'s version) rather than patching the patch.
